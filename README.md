...
- Light default, deliberate navy illustration and diagram surfaces, and a full
  dark theme. Existing saved preferences remain respected.
- The hero is a generated infrastructure illustration, not a client system.
  Three keyboard-accessible points connect its network, cyber and data areas.
...
- `assets/js/heritage-site.js`: navigation, original-logo theme selection,
  illustration points and interactive existing diagrams.
...
node --test tests/heritage-copy.test.cjs tests/signal-contract.test.cjs
node tools/sync-partials.js --check
